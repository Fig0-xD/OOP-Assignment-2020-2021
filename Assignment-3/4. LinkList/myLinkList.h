...
public:
    ...
    void concatenate(const myLinkList&);    // concatenate linklists with object as parameters
    void concatenate(const myLinkList*);    // concatenate linklists with object pointers as parameters
